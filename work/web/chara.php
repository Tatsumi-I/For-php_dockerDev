  ...
  <section>
    <div class="sectionArea">
      ...
      <div id="coading" class="contentsArea">
        <div class="desc">
          <p>ここでは石川達実の性格タイプである"INTP"の<strong>概要について</strong>紹介しますが、性格分類ツールについて詳解することがこのページの目的ではありません。</p>
          <p>また、INTPの<strong>長所だけを取り上げることは</strong>私のポリシーに反します。</p>
          <p>INTPに関する詳細や結論につきましては、<strong>是非リンクをご参照いただき、総合的にご判断</strong>いただければ幸いです。</p>
        </div>
        <h3>INTP型の人は…</h3>
        <div class="container1">
          <div class="text">
            <h4>論理学者、分析者、探求者、研究者と呼ばれるタイプです。</h4>
            <ul>
      ...
      <div class="contentsArea">
        ...
        <div class="container2">
          <div class="text">
            <h4>一例として</h4>
            <ul>
              <li><strong>合格率約10%の社内試験を5年連続で合格</strong>しました。個人的に作成した<strong>30ページ超のテスト対策用テキスト</strong>は、今でも<strong>3万人以上が閲覧出来る資料</strong>として社内サイト上に掲載されています。</li>
              <li>店舗課題を解決するための<strong>施策を企画・運営・管理</strong>して数々の成功を得ました。</li>
              <li>店舗状況や売上に関する<strong>週間業績報告を担当</strong>していました。</li>
              <li>上司への<strong>有用で正確な報連相</strong>、チームメイトへの<strong>的確でタイムリーなフィードバック</strong>が得意です。</li>
            </ul>
